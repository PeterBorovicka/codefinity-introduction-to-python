...
# Subtract the number of units sold (units_sold) from the products stock.
for i in range(len(products)):
    products[i][1] -= units_sold[i][1] #stock count - units sold

print("After sales:", products)
...
# Update the stock.
for i in range(len(products)):
    products[i][1] += shipment_received[i][1] #stock count + shipment received

print("After shipment:", products)
